...
const ControllersContext = createContext<TrackerAccountsControllersOutput | null>(null);

interface TrackerAccountsControllersProps {
  children: ReactNode;
}

export const TrackerAccountsControllers = memo<TrackerAccountsControllersProps>(({ children }) => {
...
export const useTrackerAccountsControllers = () => {
  ...
  if (!context) {
    throw new Error('useTrackerAccountsControllers must be used within TrackerAccountsControllers');
  }
  return context;
};
