...
const ControllersContext = createContext<TrackerHistoryControllersOutput | null>(null);

interface TrackerHistoryControllersProps {
  children: ReactNode;
}

export const TrackerHistoryControllers = memo<TrackerHistoryControllersProps>(({ children }) => {
...
export const useTrackerHistoryControllers = () => {
  ...
  if (!context) {
    throw new Error('useTrackerHistoryControllers must be used within TrackerHistoryControllers');
  }
  return context;
};
