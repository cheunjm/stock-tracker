...
const ControllersContext = createContext<TrackerDashboardControllersOutput | null>(null);

interface TrackerDashboardControllersProps {
  children: ReactNode;
}

export const TrackerDashboardControllers = memo<TrackerDashboardControllersProps>(({ children }) => {
...
export const useTrackerDashboardControllers = () => {
  ...
  if (!context) {
    throw new Error('useTrackerDashboardControllers must be used within TrackerDashboardControllers');
  }
  return context;
};
